...
#ifndef SearchMissionItem_H
#define SearchMissionItem_H
...
Q_DECLARE_LOGGING_CATEGORY(SearchMissionItemLog)

class SearchMissionItem : public ComplexMissionItem
{
    Q_OBJECT

public:
    SearchMissionItem(Vehicle* vehicle, QObject* parent = NULL);
    ...
    QString             mapVisualQML        (void) const final { return QStringLiteral("SearchMapVisual.qml"); }
    ...
    QString         commandDescription      (void) const final { return "Search"; }
    QString         commandName             (void) const final { return "Search"; }
...
private slots:
    ...
    void            _updateSearchPolygon     (QList<QVector<double> > wifi);
...
private:
    ...
    void _sortPointsLeft(QList<QPointF>& centroidPoints, float topLeftX, float topLeftY,float bottomRightX, float bottomRightY, double gridSize);
    void _sortPointsRight(QList<QPointF>& centroidPoints, float topLeftX, float topLeftY,float bottomRightX, float bottomRightY, double gridSize);
    ...
    int _appendWaypointToMission(QList<MissionItem*>& items, int seqNum, QGeoCoordinate& coord, QObject* missionItemParent);
    ...
    static const char* _jsonGridSizeKey;
