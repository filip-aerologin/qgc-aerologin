...
QGC_LOGGING_CATEGORY(SearchMissionItemLog, "SearchMissionItemLog")

const char* SearchMissionItem::jsonComplexItemTypeValue =           "search";

const char* SearchMissionItem::_jsonGridObjectKey =                 "grid";
const char* SearchMissionItem::_jsonGridAltitudeKey =               "altitude";
const char* SearchMissionItem::_jsonGridAltitudeRelativeKey =       "relativeAltitude";
const char* SearchMissionItem::_jsonGridAngleKey =                  "angle";
const char* SearchMissionItem::_jsonGridSpacingKey =                "spacing";
const char* SearchMissionItem::_jsonGridSizeKey =                   "gridSize";
const char* SearchMissionItem::_jsonGridEntryLocationKey =          "entryLocation";
const char* SearchMissionItem::_jsonTurnaroundDistKey =             "turnAroundDistance";
const char* SearchMissionItem::_jsonCameraTriggerDistanceKey =      "cameraTriggerDistance";
const char* SearchMissionItem::_jsonCameraTriggerInTurnaroundKey =  "cameraTriggerInTurnaround";
const char* SearchMissionItem::_jsonHoverAndCaptureKey =            "hoverAndCapture";
const char* SearchMissionItem::_jsonGroundResolutionKey =           "groundResolution";
const char* SearchMissionItem::_jsonFrontalOverlapKey =             "imageFrontalOverlap";
const char* SearchMissionItem::_jsonSideOverlapKey =                "imageSideOverlap";
const char* SearchMissionItem::_jsonCameraSensorWidthKey =          "sensorWidth";
const char* SearchMissionItem::_jsonCameraSensorHeightKey =         "sensorHeight";
const char* SearchMissionItem::_jsonCameraResolutionWidthKey =      "resolutionWidth";
const char* SearchMissionItem::_jsonCameraResolutionHeightKey =     "resolutionHeight";
const char* SearchMissionItem::_jsonCameraFocalLengthKey =          "focalLength";
const char* SearchMissionItem::_jsonCameraMinTriggerIntervalKey =   "minTriggerInterval";
const char* SearchMissionItem::_jsonCameraObjectKey =               "camera";
const char* SearchMissionItem::_jsonCameraNameKey =                 "name";
const char* SearchMissionItem::_jsonManualGridKey =                 "manualGrid";
const char* SearchMissionItem::_jsonCameraOrientationLandscapeKey = "orientationLandscape";
const char* SearchMissionItem::_jsonFixedValueIsAltitudeKey =       "fixedValueIsAltitude";
const char* SearchMissionItem::_jsonRefly90DegreesKey =             "refly90Degrees";

const char* SearchMissionItem::settingsGroup =                  "Survey";
const char* SearchMissionItem::manualGridName =                 "ManualGrid";
const char* SearchMissionItem::gridAltitudeName =               "GridAltitude";
const char* SearchMissionItem::gridAltitudeRelativeName =       "GridAltitudeRelative";
const char* SearchMissionItem::gridAngleName =                  "GridAngle";
const char* SearchMissionItem::gridSpacingName =                "GridSpacing";
const char* SearchMissionItem::gridSizeName =                   "GridSize";
const char* SearchMissionItem::gridEntryLocationName =          "GridEntryLocation";
const char* SearchMissionItem::turnaroundDistName =             "TurnaroundDist";
const char* SearchMissionItem::cameraTriggerDistanceName =      "CameraTriggerDistance";
const char* SearchMissionItem::cameraTriggerInTurnaroundName =  "CameraTriggerInTurnaround";
const char* SearchMissionItem::hoverAndCaptureName =            "HoverAndCapture";
const char* SearchMissionItem::groundResolutionName =           "GroundResolution";
const char* SearchMissionItem::frontalOverlapName =             "FrontalOverlap";
const char* SearchMissionItem::sideOverlapName =                "SideOverlap";
const char* SearchMissionItem::cameraSensorWidthName =          "CameraSensorWidth";
const char* SearchMissionItem::cameraSensorHeightName =         "CameraSensorHeight";
const char* SearchMissionItem::cameraResolutionWidthName =      "CameraResolutionWidth";
const char* SearchMissionItem::cameraResolutionHeightName =     "CameraResolutionHeight";
const char* SearchMissionItem::cameraFocalLengthName =          "CameraFocalLength";
const char* SearchMissionItem::cameraTriggerName =              "CameraTrigger";
const char* SearchMissionItem::cameraOrientationLandscapeName = "CameraOrientationLandscape";
const char* SearchMissionItem::fixedValueIsAltitudeName =       "FixedValueIsAltitude";
const char* SearchMissionItem::cameraName =                     "Camera";

SearchMissionItem::SearchMissionItem(Vehicle* vehicle, QObject* parent)
    ...
    //, _wifiLocatedList(this)
{
    _editorQml = "qrc:/qml/SearchItemEditor.qml";
    ...
    connect(&_gridSpacingFact,                  &Fact::valueChanged,                        this, &SearchMissionItem::_generateGrid);
    connect(&_gridSizeFact,                     &Fact::valueChanged,                        this, &SearchMissionItem::_generateGrid);
    connect(&_gridAngleFact,                    &Fact::valueChanged,                        this, &SearchMissionItem::_generateGrid);
    connect(&_gridEntryLocationFact,            &Fact::valueChanged,                        this, &SearchMissionItem::_generateGrid);
    connect(&_turnaroundDistFact,               &Fact::valueChanged,                        this, &SearchMissionItem::_generateGrid);
    connect(&_cameraTriggerDistanceFact,        &Fact::valueChanged,                        this, &SearchMissionItem::_generateGrid);
    connect(&_cameraTriggerInTurnaroundFact,    &Fact::valueChanged,                        this, &SearchMissionItem::_generateGrid);
    connect(&_hoverAndCaptureFact,              &Fact::valueChanged,                        this, &SearchMissionItem::_generateGrid);
    connect(this,                               &SearchMissionItem::refly90DegreesChanged,  this, &SearchMissionItem::_generateGrid);

    connect(&_gridAltitudeFact,                 &Fact::valueChanged, this, &SearchMissionItem::_updateCoordinateAltitude);

    connect(&_gridAltitudeRelativeFact,         &Fact::valueChanged, this, &SearchMissionItem::_setDirty);




    // Signal to Qml when camera value changes so it can recalc
    connect(&_groundResolutionFact,             &Fact::valueChanged, this, &SearchMissionItem::_cameraValueChanged);
    connect(&_frontalOverlapFact,               &Fact::valueChanged, this, &SearchMissionItem::_cameraValueChanged);
    connect(&_sideOverlapFact,                  &Fact::valueChanged, this, &SearchMissionItem::_cameraValueChanged);
    connect(&_cameraSensorWidthFact,            &Fact::valueChanged, this, &SearchMissionItem::_cameraValueChanged);
    connect(&_cameraSensorHeightFact,           &Fact::valueChanged, this, &SearchMissionItem::_cameraValueChanged);
    connect(&_cameraResolutionWidthFact,        &Fact::valueChanged, this, &SearchMissionItem::_cameraValueChanged);
    connect(&_cameraResolutionHeightFact,       &Fact::valueChanged, this, &SearchMissionItem::_cameraValueChanged);
    connect(&_cameraFocalLengthFact,            &Fact::valueChanged, this, &SearchMissionItem::_cameraValueChanged);
    connect(&_cameraOrientationLandscapeFact,   &Fact::valueChanged, this, &SearchMissionItem::_cameraValueChanged);

    connect(&_cameraTriggerDistanceFact, &Fact::valueChanged, this, &SearchMissionItem::timeBetweenShotsChanged);

    connect(&_mapPolygon, &QGCMapPolygon::dirtyChanged, this, &SearchMissionItem::_polygonDirtyChanged);
    connect(&_mapPolygon, &QGCMapPolygon::pathChanged,  this, &SearchMissionItem::_generateGrid);




    //connect(_vehicle, &Vehicle::wifiSignalDropped,        this, &SearchMissionItem::_updateSearchPolygon);


}

void SearchMissionItem::_updateSearchPolygon(QList<QVector<double>> wifi)
{
    qDebug() << " DOSTALEM INFO TAKIE KORDYNATY: " << wifi << endl;
}

void SearchMissionItem::_setSurveyDistance(double surveyDistance)
{
...
void SearchMissionItem::_setCameraShots(int cameraShots)
{
...
void SearchMissionItem::_setCoveredArea(double coveredArea)
{
...
void SearchMissionItem::_clearInternal(void)
{
    // Bug workaround
...
int SearchMissionItem::lastSequenceNumber(void) const
{
    return _sequenceNumber + _missionCommandCount;
}

void SearchMissionItem::setCoordinate(const QGeoCoordinate& coordinate)
{
...
void SearchMissionItem::setDirty(bool dirty)
{
    if (_dirty != dirty) {
        _dirty = dirty;
...
void SearchMissionItem::save(QJsonArray&  missionItems)
{
    ...
    gridObject[_jsonGridSizeKey] =              _gridSizeFact.rawValue().toDouble();
...
void SearchMissionItem::setSequenceNumber(int sequenceNumber)
{
...
bool SearchMissionItem::load(const QJsonObject& complexObject, int sequenceNumber, QString& errorString)
{
    ...
    QList<JsonHelper::KeyValidateInfo> gridKeyInfoList = {
        ...
        { _jsonGridSizeKey,                     QJsonValue::Double, true },
    ...
    _gridSizeFact.setRawValue               (gridObject[_jsonGridSizeKey].toDouble());
...
double SearchMissionItem::greatestDistanceTo(const QGeoCoordinate &other) const
{
...
void SearchMissionItem::_setExitCoordinate(const QGeoCoordinate& coordinate)
{
...
bool SearchMissionItem::specifiesCoordinate(void) const
{
...
void SearchMissionItem::_convertTransectToGeo(const QList<QList<QPointF>>& transectSegmentsNED, const QGeoCoordinate& tangentOrigin, QList<QList<QGeoCoordinate>>& transectSegmentsGeo)
{
...
void SearchMissionItem::_reverseTransectOrder(QList<QList<QGeoCoordinate>>& transects)
{
...
void SearchMissionItem::_reverseInternalTransectPoints(QList<QList<QGeoCoordinate>>& transects)
{
...
void SearchMissionItem::_optimizeTransectsForShortestDistance(const QGeoCoordinate& distanceCoord, QList<QList<QGeoCoordinate>>& transects)
{
...
void SearchMissionItem::_appendGridPointsFromTransects(QList<QList<QGeoCoordinate>>& rgTransectSegments)
{
    qCDebug(SearchMissionItemLog) << "Entry point _appendGridPointsFromTransects" << rgTransectSegments.first().first();
...
qreal SearchMissionItem::_ccw(QPointF pt1, QPointF pt2, QPointF pt3)
{
    return (pt2.x()-pt1.x())*(pt3.y()-pt1.y()) - (pt2.y()-pt1.y())*(pt3.x()-pt1.x());
}

qreal SearchMissionItem::_dp(QPointF pt1, QPointF pt2)
{
    return (pt2.x()-pt1.x())/qSqrt((pt2.x()-pt1.x())*(pt2.x()-pt1.x()) + (pt2.y()-pt1.y())*(pt2.y()-pt1.y()));
}

void SearchMissionItem::_swapPoints(QList<QPointF>& points, int index1, int index2)
{
...
QList<QPointF> SearchMissionItem::_convexPolygon(const QList<QPointF>& polygon)
{
...
bool SearchMissionItem::_gridAngleIsNorthSouthTransects()
{
...
void SearchMissionItem::_adjustTransectsToEntryPointLocation(QList<QList<QGeoCoordinate>>& transects)
{
    ...
    qCDebug(SearchMissionItemLog) << "Original entry point" << transects.first().first();
    qCDebug(SearchMissionItemLog) << "northSouthTransects" << northSouthTransects;

    if (northSouthTransects) {
        double firstTransectAzimuth = firstTransectEntry.azimuthTo(firstTransectExit);
        qCDebug(SearchMissionItemLog) << "firstTransectAzimuth" << firstTransectAzimuth;
        ...
        qCDebug(SearchMissionItemLog) << (entryPointBottom ? "Entry point is at bottom" : "Entry point is at top");

        double entryToExitAzimuth = firstTransectEntry.azimuthTo(lastTransectExit);
        qCDebug(SearchMissionItemLog) << "entryToExitAzimuth" << entryToExitAzimuth;
        entryPointLeft = entryToExitAzimuth <= 180.0;
        qCDebug(SearchMissionItemLog) << (entryPointLeft ? "Entry point is at left" : "Entry point is at right");
    } else {
        double firstTransectAzimuth = firstTransectEntry.azimuthTo(firstTransectExit);
        qCDebug(SearchMissionItemLog) << "firstTransectAzimuth" << firstTransectAzimuth;
    ...
    if (reversePoints) {
        qCDebug(SearchMissionItemLog) << "Reverse Points";
        _reverseInternalTransectPoints(transects);
    }
    if (reverseTransects) {
        // The only way we should end up here is if there is a bug in the original grid line generation
        qCDebug(SearchMissionItemLog) << "Not Reverse Transects";
        //_reverseTransectOrder(transects);
    }
...
void SearchMissionItem::_generateGrid(void)
{
    ...
    double gridSize = _gridSizeFact.rawValue().toDouble();
...
void SearchMissionItem::_updateCoordinateAltitude(void)
{
...
QPointF SearchMissionItem::_rotatePoint(const QPointF& point, const QPointF& origin, double angle)
{
    QPointF rotated;
...
void SearchMissionItem::_intersectLinesWithRect(const QList<QLineF>& lineList, const QRectF& boundRect, QList<QLineF>& resultLines)
{
...
void SearchMissionItem::_intersectLinesWithPolygon(const QList<QLineF>& lineList, const QPolygonF& polygon, QList<QLineF>& resultLines)
{
    resultLines.clear();
    for (int i=0; i<lineList.count(); i++) {
        int foundCount = 0;
...
void SearchMissionItem::_adjustLineDirection(const QList<QLineF>& lineList, QList<QLineF>& resultLines)
{
    qreal firstAngle = 0;
    for (int i=0; i<lineList.count(); i++) {
        const QLineF& line = lineList[i];
...
double SearchMissionItem::_clampGridAngle90(double gridAngle)
{
...
void SearchMissionItem::_sortPointsLeft(QList<QPointF>& centroidPoints, float topLeftX, float topLeftY,float bottomRightX, float bottomRightY, double gridSize)
{
    float x = 0.0;
    float y = 0.0;
    centroidPoints.clear();
    bool isOdd = true;
    while ((topLeftY + y + gridSize) < bottomRightY)
    {
        if (isOdd)
        {
            while ((topLeftX + x + gridSize)  < bottomRightX)
            {

                centroidPoints += (QPointF(topLeftX + gridSize + x, topLeftY + gridSize + y));
                x += gridSize;
            }
        }
        else
        {
            while ((topLeftX + x + gridSize)  < bottomRightX)
            {
                centroidPoints += (QPointF(bottomRightX - gridSize - x, topLeftY + gridSize + y));
                x += gridSize;
            }
...
void SearchMissionItem::_sortPointsRight(QList<QPointF>& centroidPoints, float topLeftX, float topLeftY,float bottomRightX, float bottomRightY, double gridSize)
{
    float x = 0.0;
    float y = 0.0;
    centroidPoints.clear();
...
void SearchMissionItem::_generateLines(const QList<QPointF>& polygonPoints, QList<QPointF>& centroidPoints, double gridSize, int entryLocation)
{
    QPolygonF polygon;
    for (int i=0; i<polygonPoints.count(); i++) {
        qCDebug(SearchMissionItemLog) << polygonPoints[i];
        polygon << polygonPoints[i];
    }
    // Create bounding box of polygon
    QRectF smallBoundRect = polygon.boundingRect();

    float topLeftX = smallBoundRect.topLeft().x();
    float topLeftY = smallBoundRect.topLeft().y();
    float bottomRightX = smallBoundRect.bottomRight().x();
    float bottomRightY = smallBoundRect.bottomRight().y();

    QPointF temp;
    if (entryLocation == 0){
        _sortPointsLeft(centroidPoints,topLeftX,topLeftY,bottomRightX,bottomRightY,gridSize);
    }
    else if(entryLocation == 1) {
        _sortPointsLeft(centroidPoints,topLeftX,topLeftY,bottomRightX,bottomRightY,gridSize);
        for (int i = 0; i < centroidPoints.count()/2; ++i) {
            temp = centroidPoints[centroidPoints.count()-i-1];
            centroidPoints[centroidPoints.count()-i-1] = centroidPoints[i];
            centroidPoints[i] = temp;
        }
    }
    else if (entryLocation == 2)
    {
        _sortPointsRight(centroidPoints,topLeftX,topLeftY,bottomRightX,bottomRightY,gridSize);
    }
    else if (entryLocation == 3)
    {
        _sortPointsRight(centroidPoints,topLeftX,topLeftY,bottomRightX,bottomRightY,gridSize);
        for (int i = 0; i < centroidPoints.count()/2; ++i) {
            temp = centroidPoints[centroidPoints.count()-i-1];
...
void SearchMissionItem::_pointsInPolygon (const QList<QPointF>& polygonPoints, const QList<QPointF>& centroidPoints, QList<QPointF>& pointsInPolygon)
{
    int i, j, z;
    bool inPolygon = false;
    for (z = 0 ; z < centroidPoints.count(); z++)
    {
        inPolygon = false;
        for (i = 0, j = polygonPoints.count()-1; i < polygonPoints.count(); j = i++)
        {
            if ( ((polygonPoints[i].y()>centroidPoints[z].y()) != (polygonPoints[j].y()>centroidPoints[z].y())) &&
            (centroidPoints[z].x() < (polygonPoints[j].x()-polygonPoints[i].x()) * (centroidPoints[z].y()-polygonPoints[i].y()) / (polygonPoints[j].y()-polygonPoints[i].y()) + polygonPoints[i].x()) )
             inPolygon = !inPolygon;
        }
        if (inPolygon)
        {
            pointsInPolygon.append(centroidPoints[z]);
        }
    }
}
...
void SearchMissionItem::_convertToGeoPoints (const QList<QPointF>& centroidPoints, const QGeoCoordinate& tangentOrigin, QList<QGeoCoordinate> &  geoCentroidPoints)
{
    ...
    for (int i=0; i< pointSegments.count(); i++)
    {
        //QList<QGeoCoordinate>   transectCoords;
        const QList<QPointF>&   transectPoints = pointSegments[i];
        for (int j=0; j<transectPoints.count(); j++)
        {
            QGeoCoordinate coord;
            const QPointF& point = transectPoints[j];
...
void SearchMissionItem::_convertToGeo (const QList<QPointF>& pointsInPolygon, const QGeoCoordinate& tangentOrigin)
{
    QList<QPointF> tempPoints;
    QList<QList<QPointF>> pointSegments;
    int h = 0;
...
int SearchMissionItem::_gridGenerator(const QList<QPointF>& polygonPoints,  QList<QList<QPointF>>& transectSegments, bool refly)
{
    int cameraShots = 0;
    ...
    qCDebug(SearchMissionItemLog) << "Clamped grid angle" << gridAngle;

    qCDebug(SearchMissionItemLog) << "SurveyMissionItem::_gridGenerator gridSpacing:gridAngle:refly" << gridSpacing << gridAngle << refly;

    transectSegments.clear();

    // Convert polygon to bounding rect

    qCDebug(SearchMissionItemLog) << "Polygon";
    QPolygonF polygon;
    for (int i=0; i<polygonPoints.count(); i++) {
        qCDebug(SearchMissionItemLog) << polygonPoints[i];
        polygon << polygonPoints[i];
    ...
    qCDebug(SearchMissionItemLog) << "Bounding rect" << smallBoundRect.topLeft().x() << smallBoundRect.topLeft().y() << smallBoundRect.bottomRight().x() << smallBoundRect.bottomRight().y();
    ...
    qCDebug(SearchMissionItemLog) << "Rotated bounding rect" << largeBoundRect.topLeft().x() << largeBoundRect.topLeft().y() << largeBoundRect.bottomRight().x() << largeBoundRect.bottomRight().y();
    ...
    if (northSouthTransects) {
        ...
        if (entryLocation == EntryLocationTopLeft || entryLocation == EntryLocationBottomLeft) {
            ...
            qCDebug(SearchMissionItemLog) << "Generate left to right";
            ...
            while (x < largeBoundRect.bottomRight().x()) {
                ...
                qCDebug(SearchMissionItemLog) << "line(" << lineList.last().x1() << ", " << lineList.last().y1() << ")-(" << lineList.last().x2() <<", " << lineList.last().y2() << ")";

                x += gridSpacing;
            }
        } else {
            // Generate transects from right to left
            qCDebug(SearchMissionItemLog) << "Generate right to left";
        ...
        if (entryLocation == EntryLocationTopLeft || entryLocation == EntryLocationTopRight) {
            ...
            qCDebug(SearchMissionItemLog) << "Generate top to bottom";
            ...
            while (y > largeBoundRect.topRight().y()) {
                ...
                qCDebug(SearchMissionItemLog) << "y:xLeft:xRight" << y << xLeft << xRight << "line(" << lineList.last().x1() << ", " << lineList.last().y1() << ")-(" << lineList.last().x2() <<", " << lineList.last().y2() << ")";

                y -= gridSpacing;
            }
        } else {
            // Generate transects from bottom to top
            qCDebug(SearchMissionItemLog) << "Generate bottom to top";
    ...
    for (int i=0; i<resultLines.count(); i++) {
        ...
        if (_triggerCamera() && _hoverAndCaptureEnabled()) {
            if (_triggerDistance() < transectLine.length()) {
                ...
                qCDebug(SearchMissionItemLog) << "innerPoints" << innerPoints;
...
int SearchMissionItem::_appendWaypointToMission(QList<MissionItem*>& items, int seqNum, QGeoCoordinate& coord, QObject* missionItemParent)
{
    double  altitude =          _gridAltitudeFact.rawValue().toDouble();
    bool    altitudeRelative =  _gridAltitudeRelativeFact.rawValue().toBool();

    //qCDebug(SearchMissionItemLog) << "_appendWaypointToMission seq:trigger" << seqNum << (cameraTrigger != CameraTriggerNone);
...
bool SearchMissionItem::_nextTransectCoord(const QList<QGeoCoordinate>& transectPoints, int pointIndex, QGeoCoordinate& coord)
{
...
bool SearchMissionItem::_appendMissionItemsWorker(QList<MissionItem*>& items, QObject* missionItemParent, int& seqNum, bool hasRefly, bool buildRefly)
{
    qCDebug(SearchMissionItemLog) << "hasTurnaround:triggerCamera:hoverAndCapture:imagesEverywhere:hasRefly:buildRefly" << _hasTurnaround() << _triggerCamera() << _hoverAndCaptureEnabled() << _imagesEverywhere() << hasRefly << buildRefly;

    QList<QList<QGeoCoordinate>>& transectSegments = _transectSegments;
    ...
    for (int segmentIndex=0; segmentIndex<transectSegments.count(); segmentIndex++)
    {
        ...
        qCDebug(SearchMissionItemLog) << "segment.count" << segment.count();

        if (!_nextTransectCoord(segment, pointIndex++, coord)) {
            return false;
        }
        seqNum = _appendWaypointToMission(items, seqNum, coord, missionItemParent);
...
void SearchMissionItem::appendMissionItems(QList<MissionItem*>& items, QObject* missionItemParent)
{
...
int SearchMissionItem::cameraShots(void) const
{
    return _triggerCamera() ? _cameraShots : 0;
}

void SearchMissionItem::_cameraValueChanged(void)
{
    emit cameraValueChanged();
}

double SearchMissionItem::timeBetweenShots(void) const
{
    return _cruiseSpeed == 0 ? 0 : _triggerDistance() / _cruiseSpeed;
}

void SearchMissionItem::setMissionFlightStatus(MissionController::MissionFlightStatus_t& missionFlightStatus)
{
...
void SearchMissionItem::_setDirty(void)
{
    setDirty(true);
}

bool SearchMissionItem::hoverAndCaptureAllowed(void) const
{
    return _vehicle->multiRotor() || _vehicle->vtol();
}

double SearchMissionItem::_triggerDistance(void) const {
    return _cameraTriggerDistanceFact.rawValue().toDouble();
}

bool SearchMissionItem::_triggerCamera(void) const
{
    return _triggerDistance() > 0;
}

bool SearchMissionItem::_imagesEverywhere(void) const
{
    return _triggerCamera() && _cameraTriggerInTurnaroundFact.rawValue().toBool();
}

bool SearchMissionItem::_hoverAndCaptureEnabled(void) const
{
    return hoverAndCaptureAllowed() && !_imagesEverywhere() && _triggerCamera() && _hoverAndCaptureFact.rawValue().toBool();
}

bool SearchMissionItem::_hasTurnaround(void) const
{
    return _turnaroundDistance() > 0;
}

double SearchMissionItem::_turnaroundDistance(void) const
{
    return _turnaroundDistFact.rawValue().toDouble();
}

void SearchMissionItem::applyNewAltitude(double newAltitude)
{
    _fixedValueIsAltitudeFact.setRawValue(true);
    _gridAltitudeFact.setRawValue(newAltitude);
}

void SearchMissionItem::setRefly90Degrees(bool refly90Degrees)
{
...
void SearchMissionItem::_polygonDirtyChanged(bool dirty)
{
    if (dirty) {
        setDirty(true);
    }
