...
void QGCPalette::_buildMap(void)
{
    ...
    DECLARE_QGC_COLOR(buttonHighlight,      "#e4e4e4", "#009EE0", "#3a3a3a", "#009EE0")
    DECLARE_QGC_COLOR(buttonHighlightText,  "#2c2c2c", "#ffffff", "#333333", "#000000")
    DECLARE_QGC_COLOR(primaryButton,        "#585858", "#009EE0", "#585858", "#009EE0")
    ...
    DECLARE_QGC_COLOR(mapButtonHighlight,   "#585858", "#009EE0", "#585858", "#009EE0")
    DECLARE_QGC_COLOR(mapIndicator,         "#585858", "#009EE0", "#585858", "#009EE0")
    ...
    DECLARE_QGC_COLOR(alertBackground,      "#eecc44", "#009EE0", "#eecc44", "#009EE0")
    DECLARE_QGC_COLOR(alertBorder,          "#808080", "#808080", "#808080", "#808080")
    DECLARE_QGC_COLOR(alertText,            "#000000", "#000000", "#000000", "#000000")
    DECLARE_QGC_COLOR(missionItemEditor,    "#585858", "#009EE0", "#585858", "#009EE0")
