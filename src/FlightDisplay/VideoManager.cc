...
//-----------------------------------------------------------------------------
VideoManager2::VideoManager2(QGCApplication* app, QGCToolbox* toolbox)
    : QGCTool(app, toolbox)
    , _videoReceiver(NULL)
    , _videoSettings(NULL)
    , _fullScreen(false)
...
//-----------------------------------------------------------------------------
void
VideoManager2::setToolbox(QGCToolbox *toolbox)
{
   QGCTool::setToolbox(toolbox);
   QQmlEngine::setObjectOwnership(this, QQmlEngine::CppOwnership);
...
//-----------------------------------------------------------------------------
void
VideoManager2::_videoSourceChanged()
{
    emit hasVideoChanged();
    emit isGStreamerChanged();
    _restartVideo();
